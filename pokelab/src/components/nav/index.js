const createNavigation = () => {
  ...
  $style.textContent = `
    ...
    .navigation-pokelab .-title:hover {
      color: #bd93f9;
    }
    ...
    .navigation-pokelab .navbar-nav .nav-link {
      font-family: 'Roboto Mono', monospace;
      color: #f8f8f2;
      transition: border-bottom 100ms linear;
    }

    .navigation-pokelab .navbar-nav .nav-link:hover {
      color: #bd93f9;
    }
  ...
  return `
    <nav class="navbar navbar-expand-lg navbar-dark top-bar fixed-top navigation-pokelab">
      <div class="container-fluid">
        <a class="navbar-brand h1 -title" href="/pokelab/index.html">PokéLab</a>
        <button
        ...
        <div class="collapse navbar-collapse justify-content-end collapse-pokelab" id="navbarNav">
          <ul class="navbar-nav fs-5">
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="/pokelab/index.html">Buscar</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="/pokelab/about.html">Sobre</a>
            </li>
